...
function gen_bar_graph(element_id, title, datapoints, labels) {
    ...
    set_colors((window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches && determine_current_theme() === "os-default") || determine_current_theme() === "dark-theme");
